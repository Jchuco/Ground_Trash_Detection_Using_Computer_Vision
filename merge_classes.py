...
# Função para adivinhar a superclasse com base no nome da categoria
...
# Dicionário das superclasses para IDs novos
superclass_to_id = {
    'plastic': 0,
    'paper': 1,
    'metal': 2,
...
def merge_classes_to_superclasses(input_json_path, output_json_path):
    ...
    # Criar mapeamento original ID -> superclasse
    id_to_superclass = {}
...
merge_classes_to_superclasses(
    input_json_path='./annotations.json',
    output_json_path='./annotations_5classes.json'
)
