...
def run_tests(root_dir, annotation_path):
    """Executa testes na classe TACODataset"""
    ...
    try:
        ...
        print(f"❌ Problema no formato: {str(e)}")
...
if __name__ == "__main__":
    # Configuração (ajuste os paths conforme necessário)
    root_dir = "../data/"
    annotation_file = "../data/annotations.json"
    
    # Executar testes
    run_tests(root_dir, annotation_file)